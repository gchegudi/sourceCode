...
class _EditProfileState extends State<EditProfile> {
  ...
  final _textMobileNumberController = TextEditingController(); //using as
  // mobile
  // controller
  final _textInfoController = TextEditingController();
  final _focusName = FocusNode();
  final _focusEmail = FocusNode();
  final _focusMobileNumber = FocusNode(); //mobile controller
  ...
  String _validName;
  String _validEmail;
  String _validMobileNumber; //mobile controller
  String _validInfo;
  ...
  void initState() {
    ...
    _textMobileNumberController.text = Application.user.toString(); //mobile controller
  ...
  Future<void> _update() async {
    ...
    setState(() {
      ...
      _validMobileNumber = UtilValidator.validate(
        data: _textMobileNumberController.toString(), //mobile controller
      );
    ...
    if (_validName == null &&
        _validEmail == null &&
        _validMobileNumber == null &&
        _validInfo == null) {
      AppBloc.editProfileBloc.add(
        OnChangeProfile(
          name: _textNameController.text,
          email: _textEmailController.text,
          mobileNumber: _textMobileNumberController.toString(),
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    AppTextInput(
                      ...
                      errorText: Translate.of(context).translate(_validMobileNumber),
                      focusNode: _focusMobileNumber,
                      keyboardType: TextInputType.number,
                      textInputAction: TextInputAction.done,
                      onTapIcon: () async {
                        await Future.delayed(Duration(milliseconds: 100));
                        _textMobileNumberController.toString();
                      },
                      onSubmitted: (text) {
                        UtilOther.fieldFocusChange(
                          context,
                      ...
                      onChanged: (text) {
                        setState(() {
                          _validMobileNumber = UtilValidator.validate(
                            data: _textMobileNumberController.toString(),
                            //using as mobile controller
                          );
                        });
                      },
                      icon: Icon(Icons.clear),
                      controller: _textMobileNumberController, //using as mobile controller
                    ),
                    Padding(
                      padding: EdgeInsets.only(top: 10, bottom: 10),
                      child: Text(
